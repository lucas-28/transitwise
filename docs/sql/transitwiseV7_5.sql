...
--
-- Host: localhost
-- Generation Time: Oct 11, 2023 at 04:22 AM
...
INSERT INTO `user_profile` (`UPID`, `ULID`, `UPEID`, `email`, `f_name`, `m_name`, `l_name`, `birth_date`, `address1`, `address2`, `city`, `state`, `zip`, `phone`) VALUES
(1, 1, 1, 'lpfeifer28@gmail.com', 'Lucas', '', 'Pfeifer', NULL, '355 Milewood Rd', '', 'Millbrook', 'NY', '12545', '8458676832');
...
ALTER TABLE `reservations`
  ...
  ADD CONSTRAINT `reservations_ibfk_2` FOREIGN KEY (`UPID`) REFERENCES `user_profile` (`UPID`);
...
ALTER TABLE `user_profile`
  ...
  ADD CONSTRAINT `user_profile_ibfk_3` FOREIGN KEY (`UPEID`) REFERENCES `user_permission` (`UPEID`);
COMMIT;
