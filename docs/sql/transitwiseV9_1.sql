...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 31, 2023 at 09:15 PM
...
--
-- Creation: Oct 31, 2023 at 08:12 PM
--
...
INSERT INTO `users` (`UPID`, `ULID`, `UPEID`, `f_name`, `m_name`, `l_name`, `email`, `phone`, `birth_date`, `address1`, `address2`, `city`, `state`, `zip`, `password`) VALUES
(1, 0, 1, 'Lucas', NULL, 'Pfeifer', 'lpfeifer28@gmail.com', '8458676832', '08-28-2001', '355 Milewood Rd', NULL, 'Millbrook', 'NY', '12545', '$2y$10$pQKlDc72uaLieAplmoZP1.OLXmrNv/VVExog6i8qP/wH8kp5K3ZGu'),
(9, 0, 1, '', 'Bennet', 'Pfeifer', 'lpfeifer228@gmail.com', '8458676832', '', '355 Milewood Rd', NULL, 'Millbrook', 'NY', '12545', '$2y$10$irvG4XdXf.hH0JZZlWF1f.Oh7yDEB8eQ1r08wGLPWcVAf2MmWqILu'),
(10, 0, 1, 'Aidan', 'Patrick', 'Callan', 'acallan88@gmail.com', '8454996686', '2003-08-08', '8 Haven Ct', 'Apt 1', 'Nyack', 'NY', '10960', '$2y$10$XRddl0mJBy5yTfOQDSxWLuNkkf9aRg4zxTBj2T2Tb4DZbEASVQMGO');
...
--
ALTER TABLE `users`
  MODIFY `UPID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
