...
INSERT INTO `permissions` (`UPEID`, `ULID`, `is_admin`, `is_employee`, `is_customer`) VALUES
(1, 1, 0, 0, 1),
(2, 2, 0, 0, 1),
(3, 3, 0, 0, 1),
(5, 5, 0, 0, 1);
...
--
ALTER TABLE `airlines`
  MODIFY `AL_code` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `airports`
  MODIFY `AP_code` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
...
--
ALTER TABLE `flights`
  ADD CONSTRAINT `flights_ibfk_1` FOREIGN KEY (`AL_code`) REFERENCES `airlines` (`AL_code`),
  ADD CONSTRAINT `flights_ibfk_2` FOREIGN KEY (`AP_code_D`) REFERENCES `airports` (`AP_code`),
  ADD CONSTRAINT `flights_ibfk_3` FOREIGN KEY (`AP_code_A`) REFERENCES `airports` (`AP_code`);
...
--
ALTER TABLE `permissions`
  ADD CONSTRAINT `permissions_ibfk_1` FOREIGN KEY (`ULID`) REFERENCES `user_login` (`ULID`);
